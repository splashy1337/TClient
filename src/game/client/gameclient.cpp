...
void CGameClient::OnConsoleInit()
{
	...
	m_vpAll.insert(m_vpAll.end(), {&m_Skins,
					      ...
					      &m_Motd,
					      &m_Menus,
					      &m_ModeratorPanel, // Moderator Client - after Menus so it draws on top
					      &m_ChatWatcher, // Moderator Client - passive; needs OnInit/OnConsoleInit
					      &m_Tooltips,
					      &m_Scripting, // TClient
					      &m_KeyBinder,
					      &m_GameConsole,
	...
	m_vpInput.insert(m_vpInput.end(), {&m_KeyBinder, // this will take over all input when we want to bind a key
						  ...
						  &m_Spectator,
						  &m_BindWheel, // TClient
						  &m_ModeratorPanel, // Moderator Client
						  &m_Emoticon,
						  &m_ImportantAlert,
						  &m_Menus,
						  &m_Controls,
...
void CGameClient::OnRconLine(const char *pLine)
{
	...
	m_ModeratorPanel.OnRconLine(pLine);
}
