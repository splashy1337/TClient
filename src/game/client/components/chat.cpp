...
{
	// Moderator Client: scan every incoming chat line before any display-side filtering,
	// so we still catch messages from foes/non-friends that would otherwise be hidden.
	GameClient()->m_ChatWatcher.OnChatMessage(ClientId, pLine);
