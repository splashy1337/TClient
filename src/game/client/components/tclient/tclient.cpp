...
void CTClient::OnInit()
{
	...
	if(aError[0] != '\0')
	{
		SWarning Warning(aError, TCLocalize("You have probably only installed the Moderator Client DDNet.exe which is not supported, please use the entire Moderator Client folder", "data_version.h"));
