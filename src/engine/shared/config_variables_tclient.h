...
MACRO_CONFIG_STR(McRconUsername, mc_rcon_username, 128, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Moderator rcon username for auto-login on KoG servers")
MACRO_CONFIG_STR(McRconPassword, mc_rcon_password, 128, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Moderator rcon password for auto-login on KoG servers")
MACRO_CONFIG_STR(McKogLoginCode, mc_kog_login_code, 128, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "KoG /login code for auto-login on KoG servers")
MACRO_CONFIG_STR(McAttachmentDir, mc_attachment_dir, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Directory where evidence attachments are saved (per-player subfolder); empty to use config dir")
